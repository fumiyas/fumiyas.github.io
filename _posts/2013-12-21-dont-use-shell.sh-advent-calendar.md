---
title: コマンド起動でシェルが怖いなら使わなければいいじゃない - 拡張 POSIX シェルスクリプト Advent Calendar 2013
...
コマンド起動方法も紹介すればいいのに」と思って記事を書き始めたわけですが、
...
それはシェルスクリプトそのものであり、単一のコマンド起動だけでなく、
