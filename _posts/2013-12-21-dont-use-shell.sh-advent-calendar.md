...
その困難さを示すお題を一つ。お好きな言語で `system`(3) 相当の API
...
[こちらの解説をどうぞ](/2016/12/15/positional-parameters.sh-advent-calendar.html)
)
...
Ruby の実装例です。Ruby の `system()` は Perl のそれを模倣しているようです。
